...
function buildResults() {
    ...
    var divGraphResult = `<img src="../../circuitSimulations/circuitResults/${getCircuitType()}circuit.png" id="resultImage" class="img-fluid" onError="failLoadImage()" alt="Responsive image">`;
...
function failLoadImage() {
    ...
    document.getElementById("graphResult").innerHTML = "";
    var divCircuitLoader = `<div class="alert alert-danger">
    ...
    var divReloadButton = `<div id="reloadButtonAction" class="container">
